    ...
    public class Usuario
    {
        ...
        public static void UpdateState(string email, decimal importe, string campania, string nombres, string apellidos, string empresa)
        {
            var sql = "UPDATE [dbo].[Usuario] SET IdTipo = 10, " +
                      ...
                      " FecFinAct = '" + DateTime.Now.AddDays(364).ToString("yyyyMMdd") + "'," +
                      " CodEstado = 'A'," +
                      " ImporteUSD = " + importe + "," +
        ...
        public static bool ExisUsuario(string CodUsuario)
        {
            var sql = "SELECT * FROM [dbo].[Usuario] where [CodUsuario] = '" + CodUsuario + "'";
