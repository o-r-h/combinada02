...
namespace Veritrade2017.Models.Minisite
{
    public class Resumen
    {
        ...
        public static int GetTotalEmbarques(int empresa)
        {
            ...
            // Ruben 202204
            var sql = "SELECT ISNULL(SUM(Embarques),0) as 'Embarques' FROM [Resumen] where Idempresa = " + empresa + " ";
        ...
        public static int GetTipoEmbarques(int empresa, int tipo = 0)
        {
            ...
            {
                // Ruben 202204
                sql = "SELECT ISNULL(SUM(Embarques),0) as 'Embarques' FROM [Resumen] where Idempresa = " + empresa + " AND Regimen = 'Importaciones'";
                //sql = "SELECT ISNULL(SUM(Embarques),0) as 'Embarques' FROM [Resumen] where Idempresa = " + empresa + " AND Periodo > YEAR(GETDATE()) - 5 AND Regimen = 'Importaciones'";
            }
            else
            {
                // Ruben 202204
                sql = "SELECT ISNULL(SUM(Embarques),0) as 'Embarques' FROM [Resumen] where Idempresa = " + empresa + " AND Regimen = 'Exportaciones'";
                //sql = "SELECT ISNULL(SUM(Embarques),0) as 'Embarques' FROM [Resumen] where Idempresa = " + empresa + " AND Periodo > YEAR(GETDATE()) - 5 AND Regimen = 'Exportaciones'";
            }
        ...
        public static double TotalTipoEmbarques(int empresa, int tipo = 0)
        {
            ...
            {
                // Ruben 202204
                sql = "SELECT ISNULL(SUM(Valor),0) as 'Valor' FROM [Resumen] where Idempresa = " + empresa + " AND Regimen = 'Importaciones'";
                //sql = "SELECT ISNULL(SUM(Valor),0) as 'Valor' FROM [Resumen] where Idempresa = " + empresa + " AND Periodo > YEAR(GETDATE()) - 5 AND Regimen = 'Importaciones'";
            }
            else
            {
                // Ruben 202204
                sql = "SELECT ISNULL(SUM(Valor),0) as 'Valor' FROM [Resumen] where Idempresa = " + empresa + " AND Regimen = 'Exportaciones'";
                //sql = "SELECT ISNULL(SUM(Valor),0) as 'Valor' FROM [Resumen] where Idempresa = " + empresa + " AND Periodo > YEAR(GETDATE()) - 5 AND Regimen = 'Exportaciones'";
            }
