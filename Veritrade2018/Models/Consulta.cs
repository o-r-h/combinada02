...
namespace Veritrade2018.Models
{
    public class Consulta
    {
        ...
        public static DataTable BuscaPartidasFreemium(string Nandina, string CodPais, string Idioma)
        {
            var Cant = 0;
        ...
        public static DataTable BuscaPartidasUniversidades(string Nandina, string CodPais, string Idioma)
        {
            var Cant = 0;
            string Partida = "Partida";
            if (Idioma == "en") Partida = "Partida_en";
