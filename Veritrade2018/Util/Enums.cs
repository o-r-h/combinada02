...
namespace Veritrade2018.Util
{
    public class Enums
    {
        ...
        public enum VarGrupo
        {
            ...
            [Display(Name = "VIS")] GRUPO_VISIBILIDAD
        }
        ...
        public enum VarId
        {
            ...
            [Display(Name = "XPMA")] EXCLUDE_PAIS_MA,
            ...
            [Display(Name = "VAA")] VISIBILIDAD_ALERT_ADMIN,
            [Display(Name = "VAU")] VISIBILIDAD_ALERT_USER,
            [Display(Name = "VMC")] VISIBILIDAD_MI_CUENTA,
            [Display(Name = "VPG")] VISIBILIDAD_PRUEBA_GRATIS,
            [Display(Name = "CUS")] CREDENCIAL_USER,
            [Display(Name = "CPS")] CREDENCIAL_PASSWORD,
        }
