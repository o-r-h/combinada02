...
{
    public class MisFavoritosController : BaseController
    {
        ...
        public ActionResult Index(string culture)
        {
            ...
            ViewData["TitlePerfilBar"] = Resources.MiPerfil.MyFavoritesConfiguration_Text;
        ...
        private MyFavoriteAndGroup GetMyFavoriteAndGroup(string tipoOpe, string codPais2, string codPais)
        {
            ...
            {
                // Ruben 202203
                objMyFavoriteAndGroup.ExistPartida = codPais.Length == 2 || codPais == "CRS" || codPais == "MXD" || codPais == "MXM";
                objMyFavoriteAndGroup.ExistImporter = (vFlag.ExisteImportador && tipoOpe == "I")//Funciones.ExisteVariable(codPais, tipoOpe, "IdImportador") 
                                                        ||
                                                      (tipoOpe == "I" && (codPais == "PEI" || codPais == "USI"));
                objMyFavoriteAndGroup.ExistSupplier = (vFlag.ExisteProveedor && tipoOpe == "I")
                                                        //Funciones.ExisteVariable(codPais, tipoOpe, "IdProveedor") 
                                                        ||
                                                      (tipoOpe == "I" && (codPais == "PEI" || codPais == "USI"));

                objMyFavoriteAndGroup.ExistExporter = (vFlag.ExisteExportador && tipoOpe == "E") ||
                                                        //Funciones.ExisteVariable(codPais, tipoOpe, "IdExportador") ||
                                                      (tipoOpe == "E" && (codPais == "PEE" || codPais == "USE"));

                objMyFavoriteAndGroup.ExistImporterExp = (vFlag.ExisteImportadorExp && tipoOpe == "E") ||//Funciones.ExisteVariable(codPais, tipoOpe, "IdImportadorExp") ||
                                                      (tipoOpe == "E" && codPais == "PEE" );
            }
            else
            {
        ...
        public JsonResult PaisChange(string codPais, string textCodPais)
        {
            ...
            if (objMensaje != null)
            {
                ...
                List<SelectListItem> auxCountries = new ListaPaises().GetPaisesAdmin(idioma, auxCodPais2Actual).ToList();
                if (auxCountries.FirstOrDefault(x => x.Value == auxCodPais) == null)
                {
                    auxCodPais = auxCountries.First().Value;
                    objMiPerfil.CodPaisSelected = auxCodPais;
