...
namespace Veritrade2018.Controllers.Admin
{
    public class MiPerfilController : BaseController
    {
        ...
        public ActionResult Index(string culture)
        {
            ...
            ViewData["TitlePerfilBar"] = Resources.MiPerfil.MyFavoritesAndGroupsConfiguration_Text;
        ...
        public JsonResult PaisChange(string codPais, string textCodPais)
        {
            ...
            if (objMensaje != null)
            {
                ...
                List<SelectListItem> auxCountries = objListaPaises.GetPaisesPerfil(auxCodPais2Actual, idioma).ToList();
                if (auxCountries.FirstOrDefault(x => x.Value == auxCodPais) == null)
                {
