...
// Ruben 202106
TableInfoCountry.prototype.showModalInfoColombia2021 = function () {
    $('#ModalInfoColombia2021').modal({
        show: true,
        backdrop: 'static',
        keyboard: false
    });
...
// Ruben 202307
TableInfoCountry.prototype.showModalInfoColombia2022 = function () {
    $('#ModalInfoColombia2022').modal({
        show: true,
        backdrop: 'static',
        keyboard: false
    });
...
// Ruben 202210
TableInfoCountry.prototype.showModalInfoParaguay = function () {
    $('#ModalInfoParaguay').modal({
        show: true,
        backdrop: 'static',
        keyboard: false
    });
...
Filtros.changeCboPais = function (urlPost, urlBusquedasUs, pIdioma) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // Ruben 202307
            //if (codPais == "CO"){
            //    TableInfoCountry.prototype.showModalInfoColombia2022();
            //    //TableInfoCountry.prototype.showModalInfoColombia2021();
            //}

            // Ruben 202211
            /*
            if (codPais == "PY") {
                TableInfoCountry.prototype.showModalInfoParaguay();
            }
            */
