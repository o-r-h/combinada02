...
namespace Veritrade2018.PaymeReference {
    ...
    public interface WalletCommerce {
        ...
        Veritrade2018.PaymeReference.RegisterCardHolderResponse RegisterCardHolder(Veritrade2018.PaymeReference.RegisterCardHolderRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://pe.com.alignet/WalletCommerce/RegisterCardHolder", ReplyAction="*")]
        System.Threading.Tasks.Task<Veritrade2018.PaymeReference.RegisterCardHolderResponse> RegisterCardHolderAsync(Veritrade2018.PaymeReference.RegisterCardHolderRequest request);
    }
    ...
    public partial class RegisterCardHolderRequest {
        ...
        public Veritrade2018.PaymeReference.RegisterCardHolderRequestBody Body;
        
        public RegisterCardHolderRequest() {
        }
        
        public RegisterCardHolderRequest(Veritrade2018.PaymeReference.RegisterCardHolderRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class RegisterCardHolderResponse {
        ...
        public Veritrade2018.PaymeReference.RegisterCardHolderResponseBody Body;
        
        public RegisterCardHolderResponse() {
        }
        
        public RegisterCardHolderResponse(Veritrade2018.PaymeReference.RegisterCardHolderResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WalletCommerceChannel : Veritrade2018.PaymeReference.WalletCommerce, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WalletCommerceClient : System.ServiceModel.ClientBase<Veritrade2018.PaymeReference.WalletCommerce>, Veritrade2018.PaymeReference.WalletCommerce {
        ...
        Veritrade2018.PaymeReference.RegisterCardHolderResponse Veritrade2018.PaymeReference.WalletCommerce.RegisterCardHolder(Veritrade2018.PaymeReference.RegisterCardHolderRequest request) {
        ...
        public string RegisterCardHolder(string idEntCommerce, string codCardHolderCommerce, string mail, string names, string lastNames, string reserved1, string reserved2, string reserved3, string registerVerification, out string ansDescription, out string codAsoCardHolderWallet, out string date, out string hour) {
            Veritrade2018.PaymeReference.RegisterCardHolderRequest inValue = new Veritrade2018.PaymeReference.RegisterCardHolderRequest();
            inValue.Body = new Veritrade2018.PaymeReference.RegisterCardHolderRequestBody();
            ...
            Veritrade2018.PaymeReference.RegisterCardHolderResponse retVal = ((Veritrade2018.PaymeReference.WalletCommerce)(this)).RegisterCardHolder(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Veritrade2018.PaymeReference.RegisterCardHolderResponse> Veritrade2018.PaymeReference.WalletCommerce.RegisterCardHolderAsync(Veritrade2018.PaymeReference.RegisterCardHolderRequest request) {
            return base.Channel.RegisterCardHolderAsync(request);
        }
        
        public System.Threading.Tasks.Task<Veritrade2018.PaymeReference.RegisterCardHolderResponse> RegisterCardHolderAsync(string idEntCommerce, string codCardHolderCommerce, string mail, string names, string lastNames, string reserved1, string reserved2, string reserved3, string registerVerification) {
            Veritrade2018.PaymeReference.RegisterCardHolderRequest inValue = new Veritrade2018.PaymeReference.RegisterCardHolderRequest();
            inValue.Body = new Veritrade2018.PaymeReference.RegisterCardHolderRequestBody();
            inValue.Body.idEntCommerce = idEntCommerce;
            inValue.Body.codCardHolderCommerce = codCardHolderCommerce;
            ...
            inValue.Body.reserved3 = reserved3;
            inValue.Body.registerVerification = registerVerification;
            return ((Veritrade2018.PaymeReference.WalletCommerce)(this)).RegisterCardHolderAsync(inValue);
        }
    }
}
